...
'''
driver.find_element_by_id("com.youku.phone:id/img_user").click()
driver.implicitly_wait(3)
driver.find_element_by_id("com.youku.phone:id/ucenter_header_nickname").click()
driver.implicitly_wait(3)
driver.find_element_by_id("com.youku.phone:id/passport_login_type").click()
driver.implicitly_wait(3)
driver.find_element_by_id("com.youku.phone:id/passport_username").send_keys("18511403089")
driver.implicitly_wait(3)
driver.find_element_by_id("com.youku.phone:id/passport_password").send_keys("youku1412.")
driver.implicitly_wait(3)
